...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Color(0xFFFB7185)),
        useMaterial3: true,
      ),
              ...
              itemBuilder: (context, index) {
                return Padding(
                  ...
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Icon(Icons.check_circle, color: Color(0xFFFDA4AF), size: 20),
    ...
    return Column(
      ...
      children: [
        const Padding(
          ...
          child: Row(
            children: [
              Icon(Icons.bar_chart, color: Color(0xFFFDA4AF)),
              SizedBox(width: 8),
              Text(
                'Health Charts',
                style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
