                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  const Icon(Icons.verified_user, size: 20, color: Color(0xFFFDA4AF)),
                                  const SizedBox(width: 6),
                                  Text(
                                    "Role: ${notif["role"] ?? "N/A"}",
                              ...
                              Row(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  const Icon(Icons.message_outlined, size: 20, color: Color(0xFFFDA4AF)),
                                  const SizedBox(width: 6),
                                  Expanded(
                                    child: Text(
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: (notif["isSent"] == true) ? Color(0xFFFDA4AF).withOpacity(0.1) : Colors.grey.withOpacity(0.1),
