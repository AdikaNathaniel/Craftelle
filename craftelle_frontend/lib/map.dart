            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    leading: Icon(_getPlaceIcon(placeType), color: Color(0xFFFDA4AF)),
                    title: Text(place['name']),
                    subtitle: Text('${place['distance']} km away'),
                    trailing: IconButton(
                      icon: const Icon(Icons.directions, color: Color(0xFFFDA4AF)),
      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                const Icon(Icons.directions_car, color: Color(0xFFFDA4AF), size: 30),
