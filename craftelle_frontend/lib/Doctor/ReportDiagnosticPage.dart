...
class _DiagnosticToolPageState extends State<DiagnosticToolPage> {
  ...
  Future<Uint8List> _generatePdfBytes() async {
    ...
    final image = pw.MemoryImage(
      (await rootBundle.load('assets/craftelle.png')).buffer.asUint8List(),
    );

    // Define theme colors for consistency
    final themeColor = PdfColors.indigo700;
    final accentColor = PdfColor.fromHex('#9F1239');
    final bgColor = PdfColor.fromHex('#FFF1F2');
    final borderColor = PdfColor.fromHex('#FECDD3');
