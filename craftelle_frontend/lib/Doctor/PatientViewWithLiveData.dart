                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: color?.withOpacity(0.2) ?? Color(0xFFFDA4AF).withOpacity(0.2),
                      ),
                      child: Icon(
                        icon,
                        color: color ?? Color(0xFFFDA4AF),
                        size: 36,
                      ),
                    ),
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [Color(0xFFFDA4AF), Colors.red], // Gradient background
                      ...
                      GridView.count(
                        ...
                        children: [
                          ...
                          buildAnimatedCard("Weight (kg)", 
                            personal['weight_kg'].toString(), Icons.monitor_weight, 2, color: Color(0xFFFDA4AF)),
