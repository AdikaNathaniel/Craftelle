        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                _buildStatItem(Icons.check_circle, 'Confirmed', stats['confirmed']?.toString() ?? '0', Color(0xFFFDA4AF)),
            ...
            Row(
              ...
              children: [
                ...
                _buildStatItem(Icons.trending_up, 'Confirmation Rate', stats['confirmationRate']?.toString() ?? '0%', Color(0xFFFDA4AF)),
              ],
            ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                const Icon(Icons.person, size: 18, color: Color(0xFFFDA4AF)),
                const SizedBox(width: 8),
                Text(
            ...
            Row(
              children: [
                const Icon(Icons.phone, size: 18, color: Color(0xFFFDA4AF)),
                const SizedBox(width: 8),
